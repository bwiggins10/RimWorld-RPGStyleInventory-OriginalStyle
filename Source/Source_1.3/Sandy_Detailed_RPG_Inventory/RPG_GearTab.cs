                ...
                foreach (Apparel current2 in this.SelPawnForGear.apparel.WornApparel)
                {
                    ...
                    switch (current2.def.apparel)
                    {
                       ...
                       //Panties
                        ...
                        /*//Xeva Faction Support
                        case ApparelProperties a when (a.bodyPartGroups.Contains(BodyPartGroupDefOf.Legs) && a.layers.Contains(Sandy_Gear_DefOf.VFEC_OuterShell)):
                            Rect newRectTBRD = new Rect(224f, 74f, 64f, 64f); ;
                            GUI.DrawTexture(newRectTBRD, ContentFinder<Texture2D>.Get("UI/Widgets/DesButBG", true));
                            this.DrawThingRow1(newRectTBRD, current2, false);
                            break;*/
